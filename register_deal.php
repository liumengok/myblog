...
$INS=mysql_query("Insert Into user (regname,regrealname,regpwd,regbirthday,regemail,regsex,regqq,regsign,regintroduce,fig) Values ('$regname','$regrealname','$regpwd','$regbirthday','$regemail','$regsex','$regqq','$regsign','$regintroduce',0)");
if($INS){
	echo "<meta http-equiv='Content-Type'' content='text/html; charset=utf-8'>";
